...
const TOC_HE = [
  ...
  { id: "s11b", label: "12. דיון נוסף — הגשת ראיות משלימות" },
        ...
        <div className="py-16" style={{ backgroundColor: "var(--ra-cream-50)" }}>
          <div className="max-w-4xl mx-auto px-6">
            ...
            <Section id="s2" title="2. אופי השירות — הבהרה קריטית">
              ...
              <SubSection title="2.2 אופי הניתוח המבוסס בינה מלאכותית">
                <Para>
                  הניתוח המופק על ידי הפלטפורמה מבוסס על המידע שהוגש על ידי הצדדים. כמו כל כלי טכנולוגי, הוא פועל בגבולות המידע שסופק לו ואינו מחליף שיקול דעת מקצועי פרטני. ResolveAI ממליצה לצדדים לוודא שהציגו את עמדתם באופן מלא ומדויק לצורך קבלת ניתוח מיטבי.
                </Para>
                <Para>
                  לצדדים המעוניינים בחוות דעת משפטית פרטנית — מומלץ להתייעץ עם עורך דין בנוסף לשימוש בפלטפורמה.
                </Para>
              </SubSection>

              <SubSection title="2.3 ResolveAI כחלופה לבית המשפט">
                <Para>
                  ResolveAI מציעה מסלול מהיר, זול, והוגן לפתרון סכסוכים — חלופה אמיתית להליכים משפטיים יקרים וממושכים. הפלטפורמה פועלת בהתאם לחוק הבוררות הישראלי, תשכ"ח-1968. כל צד רשאי לפנות לייעוץ משפטי עצמאי אם יבחר בכך — זכות זו אינה נשללת בשימוש בפלטפורמה.
                </Para>
              </SubSection>
            </Section>
            ...
            <Section id="s4" title="4. זכאות ותנאי שימוש מותר">
              <SubSection title="4.1 זכאות">
                <Para>
                  השירות מיועד לאנשים בני 18 שנים ומעלה, ולתאגידים הפועלים כדין. שימוש בפלטפורמה על-ידי קטינים אסור. בפתיחת תיק, המשתמש מאשר במפורש כי הוא בן 18 ומעלה.
                </Para>
              </SubSection>
            ...
            <Section id="s5" title="5. תהליך הבוררות בפלטפורמה">
              ...
              <SubSection title="5.3 תוקף הפסיקה">
                <Para>
                  פסיקת ResolveAI היא מסמך מנומק ומקצועי המשקף ניתוח מאוזן של שני הצדדים. הפסיקה ניתנת לשימוש כבסיס למשא ומתן, הסכם מחייב בין הצדדים, או הגשה לבית משפט כראיה. צדדים המעוניינים שהפסיקה תהיה מחייבת מדין יכולים לחתום מראש על הסכם בוררות המכיר ב-ResolveAI כגורם מוסכם — פעולה שהופכת את הפסיקה לאכיפה ישירות.
                </Para>
              </SubSection>
            ...
            <Section id="s7" title="7. קניין רוחני">
              ...
              <SubSection title="7.3 תוצרי AI">
                <Para>
                  תוצרי ה-AI שמייצרת הפלטפורמה עבור המשתמש הספציפי שייכים לו. אין ResolveAI רשאית לפרסם תוצרים פרטניים ללא הסכמת הצדדים.
                </Para>
              </SubSection>
            </Section>
            ...
            <Section id="s8" title="8. הגנת פרטיות">
              <Para>
                עיבוד נתונים אישיים של המשתמשים כפוף ל<Link href="/privacy" className="underline" style={{ color: "var(--ra-gold-700)" }}>מדיניות הפרטיות</Link> המהווה חלק בלתי-נפרד מתנאים אלו. מדיניות הפרטיות עומדת בדרישות חוק הגנת הפרטיות, תשמ"א-1981, ותיקון מספר 13 לחוק (2024).
              </Para>
              <Para>
            ...
            {/* ── Section 11b ── */}
            <Section id="s11b" title="12. דיון נוסף — הגשת ראיות משלימות">
              <SubSection title="12.1 זכות לבקש דיון נוסף">
                <Para>
                  לאחר מתן פסיקת הבוררות, רשאי כל צד לבקש <strong>דיון נוסף</strong>, ובלבד שברשותו ראיות משלימות שלא הוגשו במהלך הדיון הראשון ואשר עשויות להשפיע על תוצאתו.
                </Para>
              </SubSection>

              <SubSection title="12.2 תשלום ופתיחת דיון נוסף">
                <Para>
                  בקשה לדיון נוסף תוגש על-ידי הצד המבקש בלבד, ותכלול את הראיות הנוספות ואת הנימוק לכך שלא הוגשו בשלב הראשון. פתיחת דיון נוסף כרוכה בתשלום בגובה דמי פתיחת תיק, בהתאם לתכנית שנבחרה. הצד שכנגד אינו נדרש לתשלום עבור הגשת תגובתו לדיון הנוסף.
                </Para>
              </SubSection>

              <SubSection title="12.3 הליך הדיון הנוסף">
                <Para>
                  עם פתיחת הדיון הנוסף, יוכל הצד שכנגד לעיין בראיות שהוגשו ולהגיש תגובה בתוך <strong>5 ימי עסקים</strong>. חלף המועד ולא הוגשה תגובה — תינתן פסיקה על בסיס החומר הקיים. לאחר הגשת התגובה, תינתן פסיקה חדשה ומנומקת המחליפת את הפסיקה הקודמת ומהווה את ההכרעה הסופית לאותו סיבוב.
                </Para>
              </SubSection>

              <SubSection title="12.4 סיבובים נוספים">
                <Para>
                  כל צד רשאי לבקש דיון נוסף חוזר בכפוף לתשלום נוסף כאמור בסעיף 12.2. כל דיון נוסף מחייב הגשת ראיות שלא הוגשו קודם לכן.
                </Para>
              </SubSection>

              <SubSection title="12.5 סיכון הצד המבקש">
                <Para>
                  <strong>הגשת בקשה לדיון נוסף אינה מבטיחה שינוי בפסיקה לטובת המבקש, ועלולה לשנותה לרעתו.</strong> פסיקה בדיון נוסף עשויה להיטיב עם הצד שכנגד. הצד המבקש מאשר כי הוא מודע לסיכון זה ומקבל אותו על עצמו.
                </Para>
              </SubSection>

              <SubSection title="12.6 תוקף הפסיקה הקודמת במהלך הדיון הנוסף">
                <Para>
                  הגשת בקשה לדיון נוסף אינה מעכבת את תוקפה של הפסיקה הקיימת עד למתן פסיקה חדשה. ResolveAI אינה אחראית לפעולות שנקטו הצדדים בהסתמך על הפסיקה הראשונה.
                </Para>
              </SubSection>

              <SubSection title="12.7 סמכות ResolveAI לדחות בקשה">
                <Para>
                  ResolveAI שומרת לעצמה את הזכות לדחות בקשה לדיון נוסף אם לא צורפו לה ראיות חדשות של ממש. במקרה של דחייה, דמי הפתיחה יושבו למבקש במלואם.
                </Para>
              </SubSection>
            </Section>

            {/* ── Section 12 ── */}
            <Section id="s12" title="13. שינויים בתנאים">
              <Para>
                ResolveAI שומרת לעצמה את הזכות לשנות תנאים אלו בכל עת. שינויים מהותיים יפורסמו באתר ותאריך העדכון יעודכן בראש הדף לפחות 30 ימים לפני כניסתם לתוקף. המשך השימוש בפלטפורמה לאחר כניסת השינויים לתוקף מהווה הסכמה לתנאים המעודכנים. אם אינך מסכים לשינויים, עליך להפסיק את השימוש בפלטפורמה.
              </Para>
            </Section>
